package com.bptn.course._21_junit;
...
public class LeapYearTest {
	...
	// Test case to check if a year is a leap year
	  ...
	  public void testLeapYear() {
	    ...
	    // Call the method isLeapYear() and pass "year" as an argument to it,
	    // store the result in a variable of boolean type called "actualResult"
	    boolean actualResult = isLeapYear(year);

	    // Verify if the actual result is equal to the expected result using assertTrue()
	    assertTrue(actualResult == expectedResult, "Year " + year + " should be a leap year");
	  }
	  ...
	  public void testNotLeapYear() {
	    ...
	    // Verify if the actual result is equal to the expected result using assertTrue()
	    assertTrue(actualResult == expectedResult, "Year " + year + " should not be a leap year");
	  }
